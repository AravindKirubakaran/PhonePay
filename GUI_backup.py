...
#     st.markdown("---")
#     st.header("Overview")
#     st.info("Use the sidebar on the left to navigate between different data exploration topics.")
#     st.subheader("Goal:")
#     st.write(
#         "This application provides interactive visualizations to decode critical business patterns, including transaction growth, device usage, and regional market penetration across the PhonePe platform.")
#
...
#     )
#
#     # 2. Quarter Selector (NEW FILTER - Multiselect)
#     all_quarters = [1, 2, 3, 4]  # Standard quarters
#     # Ensure quarters in data are valid before unique() if dynamic
...
#
#     # Filter by Quarter (NEW FILTER APPLICATION)
...
#
#     # NOTE: The District filter application logic is removed.
#
#     # --- Aggregate Data for Map ---
#     # Aggregate by 'State'
#     df_map_data = df_filtered.groupby('State')['MetricCount'].sum().reset_index()
#
...
#
#     # Dynamic Title
#     title_parts = ["Total Metric Count by State"]
#
#     if selected_state != 'All States':
...
#
#     # Updated Title to reflect Quarter and Year
...
#
#     st.markdown("---")
#     st.subheader("Data Summary for Map")
#     st.write(
#         "The map displays the aggregated **Total Count** (MetricCount) for the selected filters, using the **State** column directly for GeoJSON mapping."
#     )
#     st.dataframe(df_map_data)
